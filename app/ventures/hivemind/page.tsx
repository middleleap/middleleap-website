...
const data: ProjectPageData = {
  ...
  hero: {
    ...
    actions: [
      ...
      { label: "View repository ↗", href: "https://github.com/middleleap/hivemind", kind: "secondary", external: true },
    ],
    snapshot: "Evidence snapshot · repository main at 7e23cfe · reviewed 11 July 2026",
  },
  status: {
  ...
  sources: [
    { id: "R1", label: "Repository overview and product principles", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/README.md" },
    { id: "R2", label: "Binding Claude Code conventions", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/CLAUDE.md" },
    { id: "R3", label: "Technical architecture", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/docs/HiveMind_Technical_Architecture.md" },
    { id: "R4", label: "Phase 0 build plan", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/docs/BUILD_PLAN.md" },
    { id: "R5", label: "Post-Phase-0 roadmap", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/ROADMAP.md" },
    { id: "R6", label: "Claude Code hooks and plugins", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/.claude/settings.json" },
    { id: "R7", label: "Continuous-integration workflow", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/.github/workflows/ci.yml" },
    { id: "R8", label: "Deployment runbook", href: "https://github.com/middleleap/hivemind/blob/7e23cfe/DEPLOY.md" },
  ],
  engage: {
