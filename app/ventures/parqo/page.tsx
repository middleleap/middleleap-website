...
const data: ProjectPageData = {
  ...
  hero: {
    ...
    actions: [
      ...
      { label: "View repository ↗", href: "https://github.com/middleleap/parqo", kind: "secondary", external: true },
    ],
    snapshot: "Evidence snapshot · repository main at 79cd4aa · reviewed 11 July 2026",
  },
  status: {
  ...
  sources: [
    { id: "R1", label: "Repository overview and shipped scope", href: "https://github.com/middleleap/parqo/blob/79cd4aa/README.md" },
    { id: "R2", label: "Approved v0.4 specification", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/11_v0.4_specification.md" },
    { id: "R3", label: "Current acquisition website stack", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/17_acquisition_website_stack.md" },
    { id: "R4", label: "AI-native delivery controls", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/16_ai_native_delivery.md" },
    { id: "R5", label: "First Codex implementation prompt", href: "https://github.com/middleleap/parqo/blob/79cd4aa/scripts/first_codex_prompt.md" },
    { id: "R6", label: "Ordered implementation backlog", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/08_backlog.md" },
    { id: "R7", label: "Operations runbook", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/19_operations_runbook.md" },
    { id: "R8", label: "Notion leads dashboard automation", href: "https://github.com/middleleap/parqo/blob/79cd4aa/docs/20_notion_leads_dashboard.md" },
  ],
  engage: {
