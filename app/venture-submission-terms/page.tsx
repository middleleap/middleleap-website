  ...
  return (
    <main className={styles.shell} id="problem" tabIndex={-1}>
      ...
      <article className={styles.content}>
        ...
        <section><h2>Acceptance record</h2><p>The Venture Studio proposal tool adds the applicable terms version and submission time to the proposal email. Keep your own copy of the brief for your records. If you do not agree to these terms, do not send the proposal.</p></section>
