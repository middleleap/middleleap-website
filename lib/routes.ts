...
export const routes = [
  ...
  { path: "/ventures/backoffice", contentUpdated: "2026-08-06", changeFrequency: "monthly", priority: 0.7 },
  { path: "/ventures/hivemind", contentUpdated: "2026-08-06", changeFrequency: "monthly", priority: 0.7 },
  { path: "/ventures/parqo", contentUpdated: "2026-08-06", changeFrequency: "monthly", priority: 0.7 },
