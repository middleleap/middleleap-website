...
const T = {
  ...
  paperText0:'#1B1B1B', paperText1:'#2B2925', paperText2:'#4D4942', paperText3:'#5F5B54',
...
const pairs = [
  ...
  ['inverse-panel micro accent ember-700 on bone-0', T.ember700, T.bone0, 4.5],
  ['light-theme inverse-panel accent ember-400 on paper-text-0', T.ember400, T.paperText0, 4.5],
  ...
  ['paper caption on paper-2 (worst)', T.paperText3, T.paper2, 5.0],
